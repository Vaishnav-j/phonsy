...
public class ServiceReciever extends BroadcastReceiver implements OnInitListener, OnUtteranceCompletedListener//Service for Text to speech
{
	...
	@Override
	public void onReceive(Context context, Intent intent) //Phone Call Reciever
	{
	    ...
	    try {
	       ...
	       //Glb G=(Glb)context.getApplicationContext();
	         // String ts =sharedpreferences.getString("State",null);
		       String ts=sharedpreferences.getString("State",null);
