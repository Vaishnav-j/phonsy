...
public class TTS extends Service implements TextToSpeech.OnInitListener, OnUtteranceCompletedListener {//Text to speech's service
    private TextToSpeech mTts;
    private String spokenText="default";
    
    @Override
    public void onCreate() {
    	//.Toast.makeText(getApplicationContext(),"Tts Service started",Toast.LENGTH_SHORT).show();
    ...
    public void onInit(int status) {
        ...
        if (status == TextToSpeech.SUCCESS) 
            ...
            if (result != TextToSpeech.LANG_MISSING_DATA && result != TextToSpeech.LANG_NOT_SUPPORTED) 
            {
             ...
             //.Toast.makeText(getApplicationContext(),"Servce middle",Toast.LENGTH_SHORT).show();
